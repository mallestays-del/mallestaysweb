...
import { generateWebsiteSchema, generateLocalBusinessSchema, generateFAQSchema, generateVillaListSchema } from '@/lib/schema';
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen" data-testid="home-page">
      ...
      <SchemaMarkup schema={generateLocalBusinessSchema(reviews)} />
      <SchemaMarkup schema={generateFAQSchema(homeFaqs)} />
      {featuredVillas.length > 0 && <SchemaMarkup schema={generateVillaListSchema(featuredVillas)} />}
